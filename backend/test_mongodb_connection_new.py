"""
Test script to check MongoDB Atlas connection with the new settings.
"""
import os
import sys
import django
...
def test_mongodb_connection():
    ...
    print("Testing MongoDB Atlas connection with new settings...")
    ...
    try:
        ...
        if 'test_connection_new' not in collections:
            db.create_collection('test_connection_new')
            print("Created test_connection_new collection")
        
        # Insert a test document
        test_collection = db['test_connection_new']
        result = test_collection.insert_one({
            'test': 'Connection successful with new settings',
